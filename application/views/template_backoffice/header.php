                    ...
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="nav-parent">
                            ...
                            <ul class="children collapse">
                                ...
                                <li><a href="<?php echo base_url('index.php/jenis/dak') ?>"> Master Bidang DAK</a></li>
                                <li><a href="<?php echo base_url('index.php/sub_jenis/dak') ?>"> Master Sub Bidang DAK</a></li>
                                <li><a href="<?php echo base_url('index.php/jenis/bku') ?>"> Master Bidang BKU</a></li>
                                <li><a href="<?php echo base_url('index.php/sub_jenis/bku') ?>"> Master Sub Bidang BKU</a></li>
                              </ul>
                        </li>
                           <li class="nav-parent">
                            <a href=""><i class="icon-note"></i><span data-translate="forms">INPUT DATA</span><span class="fa arrow"></span></a>
                            <ul class="children collapse">
                                <li><a href="<?php echo base_url('index.php/dak') ?>">DAK</a></li>
                                <li><a href="<?php echo base_url('index.php/bku') ?>">BKU</a></li>
                              </ul>
                        </li>
                        <li class="nav-parent">
